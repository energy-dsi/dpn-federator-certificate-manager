...
We are also grateful to National Digital Twin Programme [NDTP](https://ndtp.co.uk/) for the collaboration that has helped shape this repository.
...
Copyright 2026 National Energy System Operator (NESO) and Crown.  This work is licensed under the Open Government Licence 3.0 (OGL). This work has been developed by NESO using content licensed by the Department for Business and Trade (UK) under the OGL.   
